...
const Footer = () => {
  ...
  return (
    <footer className="absolute bottom-0 bg-[#1B3D1B] shadow w-full">
        ...
        <div className="sm:flex items-center justify-between">
          ...
          <ul className="flex flex-wrap items-center text-sm font-medium text-[#E8F5E9] list-none">
            <li>
              <Link
                to="/about-us"
                className="me-4 md:me-6 text-[#E8F5E9] no-underline hover:text-[#4CAF50] transition-all"
              >
                About Us
              </Link>
            </li>
            ...
            <li>
              <Link
                to="/contact-us"
                className="text-[#E8F5E9] no-underline hover:text-[#4CAF50] transition-all"
              >
                Contact Us
              </Link>
            </li>
